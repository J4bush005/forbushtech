        ...
        <div className="row">
          <div className="col-12">
            <p id="body-text" className="fw-normal">
              ...
              change. Through our relentless pursuit of excellence, we aim to empower
              industries, organizations, and individuals to unlock their full
              potential. By embracing cutting-edge solutions and fostering a
              culture of collaboration, we aspire to be at the forefront of
